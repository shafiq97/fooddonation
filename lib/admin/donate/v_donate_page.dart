...
class ADonatePage extends StatefulWidget {
  const ADonatePage({super.key});

  @override
  State<ADonatePage> createState() => _ADonatePageState();
}

class _ADonatePageState extends State<ADonatePage> {
